...
def scrape_blinkit_products(search_query, location=None, headless=True, max_products=50, search_debug=False, search_timestamp=None):
    """
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                if search_debug and search_timestamp:
                    ...
                    filename = f"blinkit_search_{safe_query}.json"
                else:
